#!/usr/bin/env python3
"""
F1 Matching System for FastAPI Web Application
"""
...
class F1MatchingSystem:
    ...
    async def initialize(self):
        ...
        try:
            ...
            if not octsu_index_path or not f1_index_path:
            ...
            self.f1_db = FAISS.load_local(f1_index_path, 
                                          f1_embeddings_model, 
                                          allow_dangerous_deserialization=True)
            ...
            def dual_search(query):
                ...
                f1_docs = self.f1_db.similarity_search(query_str, k=2)
...
{context}"""
            ...
            print(f"❌ Error initializing F1 matching system: {e}")
            raise
    ...
    async def process_query(self, query: str) -> str:
        ...
        if not self._ready:
            raise RuntimeError("F1 matching system not initialized")
        ...
        try:
            ...
            print(f"❌ Error processing F1 query: {e}")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            "status": "ready",
            "f1_documents": self.f1_db.index.ntotal if self.f1_db else 0,
